...
export var MOBILE_GLOBAL_CSS = [
  ...
  ".mod-glow{pointer-events:none!important}",
  ".pj-page,.pw{isolation:isolate}",
  ".pj-top,.pj-scroll,.pw-head,.pw-main{pointer-events:auto}",
  ".pw-side--closed{pointer-events:none!important}",
  "}",
