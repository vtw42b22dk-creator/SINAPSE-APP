...
var CHRO_CSS = [
  ...
  ".ch-modes{display:flex;gap:0;padding:3px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07)}",
  ".ch-mode{position:relative;padding:10px 16px;border:none;border-bottom:2px solid transparent;background:transparent;color:#6E6E76;font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:.5px;cursor:pointer;transition:color var(--dur) var(--ease),border-color var(--dur) var(--ease),background var(--dur) var(--ease),transform var(--dur-fast) var(--ease)}",
  ".ch-mode:hover{color:#A0A0A8;background:rgba(255,255,255,.03)}",
  ".ch-mode.is-on{color:var(--mc);border-bottom-color:var(--mc);background:color-mix(in srgb,var(--mc) 12%,transparent)}",
  ...
  ".ch-rail-day::after{content:'';position:absolute;bottom:0;left:20%;right:20%;height:2px;background:var(--mc);transform:scaleX(0);transition:transform var(--dur) var(--ease)}",
  ".ch-rail-day:hover{color:#A0A0A8;transform:translateY(-1px)}",
  ...
  ".ch-wk-strip-cell.is-on::after{content:'';position:absolute;bottom:0;left:12%;right:12%;height:2px;background:var(--mc)}",
  ...
  ".ch-wk-strip-cell.is-today .ch-wk-strip-num{outline:1px solid color-mix(in srgb,var(--mc) 45%,transparent);padding:4px 7px}",
  ...
  ".ch-wk-ev{position:absolute;z-index:10;display:flex;min-height:24px;cursor:grab;touch-action:none;overflow:hidden;transition:transform .18s var(--ease),filter .18s,z-index 0s}",
  ...
  ".ch-month-cell:hover{color:#EDEDEF;transform:scale(1.06)}",
  ".ch-month-cell.is-out{opacity:.25}",
  ".ch-month-cell.is-on{color:var(--mc)}",
  ".ch-month-cell.is-on::after{content:'';position:absolute;bottom:8px;width:16px;height:2px;background:var(--mc)}",
