      ...
      {COLORS.map(function(c, i) {
        ...
        return (
          <button
            ...
            style={{ background: c, boxShadow: on ? "0 0 0 2px #0A0A0F, 0 0 0 4px " + c + ", 0 0 14px " + c + "88" : "none" }}
          />
        );
      })}
    </div>
