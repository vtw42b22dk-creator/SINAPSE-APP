...
var WL_CSS = [
  ".wl-lbl{margin:0;font-family:'JetBrains Mono',monospace;font-size:10px;line-height:1.5;letter-spacing:1.8px;text-transform:uppercase;color:#6E6E76}",
  ".wl-btn{display:inline-flex;align-items:center;justify-content:center;gap:6px;min-height:36px;padding:8px 2px;",
  "background:transparent;border:none;border-bottom:1px solid currentColor;color:var(--wl-fg,#A0A0A8);",
  "cursor:pointer;font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:.4px}",
  ".wl-btn:hover{color:#EDEDEF}",
  ".wl-grp{flex:1;min-width:0;text-align:left;padding:12px 0;cursor:pointer;",
  ...
  "background:transparent;border:none;border-bottom:1px solid var(--wl-bd,rgba(255,255,255,0.08));color:var(--wl-fg);",
  "transition:color var(--dur) var(--ease),border-color var(--dur) var(--ease)}",
  ".wl-grp:hover{color:#EDEDEF;border-bottom-color:rgba(255,255,255,0.22)}",
  ".wl-icon{display:inline-flex;align-items:center;justify-content:center;width:30px;height:30px;flex-shrink:0;padding:0;",
  "background:transparent;border:none;color:#6E6E76;cursor:pointer;font-size:14px;line-height:1}",
  ".wl-icon:hover{color:#EDEDEF}",
  ".wl-in{width:100%;box-sizing:border-box;min-height:44px;padding:11px 0;",
  ...
  ".wl-in:focus{border-bottom-color:rgba(255,255,255,0.4)}",
  ".wl-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(268px,1fr));gap:0 32px;align-items:start}",
  ".wl-card{border:none;border-bottom:1px solid rgba(255,255,255,0.08);background:transparent;padding:18px 0}",
  ".wl-title{margin:0;font-size:15px;font-weight:400;line-height:1.4;overflow:hidden;overflow-wrap:anywhere;",
  "display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;letter-spacing:-0.02em}",
  ...
  ".wl-price{font-family:'JetBrains Mono',monospace;font-variant-numeric:tabular-nums;font-size:13px;font-weight:400;color:#EDEDEF;white-space:nowrap}",
  ".wl-prio{font-family:'JetBrains Mono',monospace;font-size:10px;line-height:1.5;letter-spacing:1.6px}",
  ".wl-link{display:inline-flex;align-items:center;padding:0;border:none;border-bottom:1px solid rgba(255,255,255,0.18);",
  "background:transparent;color:#A0A0A8;font-size:11px;line-height:1.5;text-decoration:none;white-space:nowrap}",
  ".wl-link:hover{color:#EDEDEF;border-bottom-color:#EDEDEF}",
  ".wl-check{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;flex-shrink:0;padding:0;",
  "font-size:11px;line-height:1;cursor:pointer;",
  "background:transparent;border:1px solid var(--wl-bd);color:var(--wl-fg)}",
  ".wl-empty{grid-column:1/-1;margin:0;padding:40px 0;text-align:left;font-size:13px;line-height:1.5;color:#6E6E76}",
  "@media(max-width:719px){.wl-grid{grid-template-columns:1fr}.wl-btn{min-height:44px;font-size:12px}",
  ".wl-grp{min-height:44px;font-size:15px}.wl-icon{width:38px;height:38px}.wl-title{font-size:16px}.wl-notes{font-size:13px}}",
].join("");
