...
var TASKS_CSS = [
  ...
  ".tk-card{padding:16px 0;background:transparent;border:none;border-bottom:1px solid rgba(255,255,255,0.08);",
  "transition:opacity var(--dur) var(--ease)}",
  ".tk-card:hover{opacity:1}",
  ".tk-card.is-done{opacity:.5}",
  ".tk-card.is-late{border-bottom-color:rgba(192,140,140,0.45)}",
  ".tk-check{display:flex;align-items:center;justify-content:center;width:18px;height:18px;flex-shrink:0;margin-top:3px;",
  "border:1px solid rgba(255,255,255,0.28);background:transparent;color:transparent;font-size:11px;cursor:pointer;padding:0;",
  "transition:background var(--dur) var(--ease),border-color var(--dur) var(--ease),color var(--dur) var(--ease)}",
  ".tk-check:hover{border-color:rgba(255,255,255,0.6)}",
  ".tk-check.on{background:#E6E6E9;border-color:#E6E6E9;color:#070708}",
  ...
  ".tk-sub>button{display:flex;align-items:center;justify-content:center;width:14px;height:14px;flex-shrink:0;padding:0;",
  "border:1px solid rgba(255,255,255,0.22);background:transparent;color:transparent;font-size:9px;cursor:pointer}",
  ...
  ".tk-act>button{background:none;border:none;color:#6E6E76;cursor:pointer;font-size:12px;line-height:1;padding:5px 6px}",
  ".tk-act>button:hover{color:#EDEDEF}",
  ...
  ".tk-in{background:transparent;border:none;border-bottom:1px solid rgba(255,255,255,0.14);color:#EDEDEF;outline:none;font-family:inherit}",
  ".tk-in:focus{border-bottom-color:rgba(255,255,255,0.4)}",
  ".tk-col{padding:8px 0 18px;background:transparent;border:none}",
  ".tk-tab{display:flex;align-items:center;gap:16px;width:100%;text-align:left;padding:18px 0;cursor:pointer;",
  "font-family:inherit;border:none;border-bottom:1px solid rgba(255,255,255,0.08);background:transparent}",
  ".tk-tab:active{opacity:.7}",
].join("");
