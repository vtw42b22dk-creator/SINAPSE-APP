...
var TASKS_CSS = [
  ...
  ".tk-card{padding:18px 4px 18px 0;background:transparent;border:none;border-bottom:1px solid rgba(255,255,255,.07);transition:opacity var(--dur) var(--ease),border-color var(--dur) var(--ease),padding-left var(--dur) var(--ease),transform var(--dur-fast) var(--ease)}",
